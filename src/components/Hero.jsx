        ...
        <div className="hero -mt-16">
            <div className="hero-content text-center">
                <div className="max-w-lg">
                    <h1 className="text-5xl font-bold">Welcome to <span className="bg-gradient-to-r bg-300% from-primary to-secondary to-green-400 text-transparent bg-clip-text animate-gradient">ByteBlaze</span></h1>
                    ...
                    <div className="space-x-2">
                        <Link to='/blogs' className="relative inline-block px-4 py-2 font-medium group">
                            ...
                            <span className="relative text-black group-hover:text-white">Real Blogs</span>
                        </Link>
